...
<div id="pagecontainer">
	...
	<h1>A R C H I V E &nbsp o f &nbsp S I L E N C E </h1>
		...
		<a id="sectiontitle">C O N - V O L V - O</a><br><br><br>
            ...
            <p><button class="btn" onclick="document.forms[0].submit();">C O N V O L V E &nbsp I T !</button></p>
            </form>
            <?php else: ?>
            
            <p><?php echo $error; ?></p>
            <p><button class="btn" onclick="document.location.href='convolvo.php';">T R Y &nbsp A G A I N</button></p>
